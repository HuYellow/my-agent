...
describe("desktop thread smoke", () => {
  ...
  it("renders review and steer entrypoints in the thread view source", () => {
    ...
    expect(source).toContain("评审");
    expect(source).toContain("Runtime");
    expect(source).toContain("安装插件");
    expect(source).toContain("Git URL");
    expect(source).toContain("npm package");
    expect(source).toContain("components=");
    expect(source).toContain("format=");
    expect(source).toContain("模板与分发");
    expect(source).toContain("DistributionTemplatesCard");
    expect(source).toContain("生成模板");
    expect(source).toContain("计划");
    expect(source).toContain("打开回合");
    expect(source).toContain("打开评审");
    ...
    expect(source).toContain("归档输出");
    expect(source).toContain("artifactSummary");
    expect(source).toContain("executionContextId");
    expect(source).toContain("失败产物");
    expect(source).toContain("重试步骤");
    ...
    expect(source).toContain("创建自动化");
    expect(source).toContain("运行自动化");
    expect(source).toContain("visibleAutomations");
    expect(source).toContain("执行上下文链路");
  ...
  it("keeps desktop bridge methods in sync for turn/steer and review APIs", () => {
    ...
    expect(preloadSource).toContain("installPlugin");
    ...
    expect(envSource).toContain("installPlugin");
    ...
    expect(mainSource).toContain('"plugin:install"');
